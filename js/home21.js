...
Зарегистрируйте 10 пользователей с разными именами и email адресами.
...
/*
Сделайте, чтобы на странице add-user.html пользователь регистрировался 
на сервере.
*/

// Внимание - вам необходимо сделать 1 метод который будет отправлять запросы 
// Данный метод должен быть доступ в каждом вашем классе
